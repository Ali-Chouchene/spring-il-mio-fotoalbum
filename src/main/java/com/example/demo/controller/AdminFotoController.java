...
public class AdminFotoController {
	...
	public String indexFiltro(Model model, Authentication authentication,
...
//			}
	...
	public String edit(Model model, Authentication authentication, @PathVariable int id) {
		User user = null;
		if (authentication != null) {
			Object principal = authentication.getPrincipal();
			if (principal instanceof User) {
	...
	public String update(@Valid @ModelAttribute Foto foto, BindingResult bindingResult, @PathVariable int id,
